    ...
    <div>
      ...
      <div className="w-screen px-5 relative py-10 flex flex-col items-center justify-center">
        ...
        <div className="w-screen  items-stretch px-3 lg:px-10    grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            ...
            {
            tools?.map((tool) => {
              if (categories.tools.includes( tool.id)) {
                return (<div className="w-full lg:w-3/4 my-5 lg:my-10 hover:shadow-none transition-all ease-in-out hover:-translate-y-2 hover:scale-95 cursor-pointer mx-auto shadow-2xl rounded-3xl flex flex-col  overflow-hidden">
                  <Link
